...
br.getPageURI = function(index, reduce, rotate) {
	...
	{
		$.ajax({type: "POST", url: "../templates/bgconvert.php?level="+level+"&index="+index+"&book_id="+book.book_id+"&imgurl="+book.imgurl+"&mode="+this.mode, async: true , data : {book:this.book.imglist}});
